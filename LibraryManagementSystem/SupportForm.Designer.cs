namespace GUI_UI
{
    partial class SupportForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            groupBox2.Location = new Point(341, 728);
            groupBox2.Margin = new Padding(6);
            groupBox2.Name = "groupBox2";
            groupBox2.Padding = new Padding(6);
            groupBox2.Size = new Size(996, 266);
            groupBox2.TabIndex = 17;
            groupBox2.TabStop = false;
            groupBox2.Text = "Địa chỉ liên hệ";
            // 
            // label8
            // 
            ...
            label6.Location = new Point(222, 190);
            label6.Margin = new Padding(6, 0, 6, 0);
            label6.Name = "label6";
            label6.Size = new Size(475, 48);
            label6.TabIndex = 4;
            label6.Text = "support24/7@gmail.com";
            // 
            // label7
            // 
            label7.AutoSize = true;
            label7.Font = new Font("Microsoft Sans Serif", 13.8F);
            label7.Location = new Point(222, 99);
            label7.Margin = new Padding(6, 0, 6, 0);
            label7.Name = "label7";
            label7.Size = new Size(718, 48);
            label7.TabIndex = 3;
            label7.Text = "đường số 3, phường An Hòa, TP.HCM";
            // 
            // groupBox1
            // 
            ...
            groupBox1.Location = new Point(341, 432);
            groupBox1.Margin = new Padding(6);
            groupBox1.Name = "groupBox1";
            groupBox1.Padding = new Padding(6);
            groupBox1.Size = new Size(996, 266);
            groupBox1.TabIndex = 16;
            groupBox1.TabStop = false;
            groupBox1.Text = "Số điện thoại hỗ trợ";
            // 
            // label2
            // 
            ...
            label2.TabIndex = 1;
            label2.Text = "Hotline liên hệ:";
            // 
            // label5
            // 
            label5.AutoSize = true;
            label5.Font = new Font("Microsoft Sans Serif", 13.8F);
            label5.Location = new Point(350, 190);
            label5.Margin = new Padding(6, 0, 6, 0);
            label5.Name = "label5";
            label5.Size = new Size(272, 48);
            label5.TabIndex = 4;
            label5.Text = "199 165 1976";
            // 
            // label4
            // 
            ...
            label4.Name = "label4";
            label4.Size = new Size(272, 48);
            label4.TabIndex = 3;
            label4.Text = "199 185 1969";
            // 
            // label9
            // 
            label9.AutoSize = true;
            label9.ForeColor = Color.Red;
            label9.Location = new Point(341, 1132);
            label9.Margin = new Padding(6, 0, 6, 0);
            label9.Name = "label9";
            label9.Size = new Size(1159, 37);
            label9.TabIndex = 19;
            label9.Text = "*Nếu bạn gặp khó khăn gì trong quá trình sử dụng hãy liên với chúng để đươc giải quyết vấn đề.";
            // 
            // pictureBox1
            // 
            pictureBox1.Image = (Image)resources.GetObject("pictureBox1.Image");
            pictureBox1.Location = new Point(1691, 442);
            pictureBox1.Margin = new Padding(6);
            pictureBox1.Name = "pictureBox1";
            pictureBox1.Size = new Size(390, 257);
